      ...
      {patient && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 left-0 h-full w-full max-w-md z-50 glass-surface border-r border-border overflow-y-auto"
          >
            <div className="p-5 space-y-5">
              ...
              {/* Countdown Timer */}
              <CountdownTimer arrivalTime={patient.arrivalTime} priority={patient.priority} />
